...
public class game4Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        game4DbRef = dbRef.child("leapscore").child(g1leapID).child("Game4");
        ...
        game4DbRef.addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        game4DbRef.setValue(new LeapScore(g1leapID, leaperOneScore, leaperTwoScore, "1", myPhoneNumber, winner, looser));
                ...
                public void onClick(View v) {
                    ...
                    confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            game4DbRef.child("resetBy").setValue(myPhoneNumber);
                            game4DbRef.child("scoreStatus").setValue("2");
                ...
                public void onClick(View v) {
                    ...
                    confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            game4DbRef.child("scoreStatus").setValue("0");
