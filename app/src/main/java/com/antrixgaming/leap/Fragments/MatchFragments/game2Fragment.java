...
public class game2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        game2DbRef = dbRef.child("leapscore").child(g1leapID).child("Game2");
        ...
        game2DbRef.addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        game2DbRef.setValue(new LeapScore(g1leapID, leaperOneScore, leaperTwoScore, "1", myPhoneNumber, winner, looser));
                ...
                public void onClick(View v) {
                    ...
                    confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            game2DbRef.child("resetBy").setValue(myPhoneNumber);
                            game2DbRef.child("scoreStatus").setValue("2");
                ...
                public void onClick(View v) {
                    ...
                    confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            game2DbRef.child("scoreStatus").setValue("0");
