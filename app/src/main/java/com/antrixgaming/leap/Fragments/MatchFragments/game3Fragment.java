...
public class game3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        game3DbRef = dbRef.child("leapscore").child(g1leapID).child("Game3");
        ...
        game3DbRef.addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        game3DbRef.setValue(new LeapScore(g1leapID, leaperOneScore, leaperTwoScore, "1", myPhoneNumber, winner, looser));
                ...
                public void onClick(View v) {
                    ...
                    confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            game3DbRef.child("resetBy").setValue(myPhoneNumber);
                            game3DbRef.child("scoreStatus").setValue("2");
                ...
                public void onClick(View v) {
                    ...
                    confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            game3DbRef.child("scoreStatus").setValue("0");
