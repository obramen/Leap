...
public class game5Fragment extends Fragment {

    Context context;

    DatabaseReference dbRef;
    DatabaseReference game5DbRef;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        game5DbRef = dbRef.child("leapscore").child(g1leapID).child("Game5");
        ...
        game5DbRef.addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        game5DbRef.setValue(new LeapScore(g1leapID, leaperOneScore, leaperTwoScore, "1", myPhoneNumber, winner, looser));
                ...
                public void onClick(View v) {
                    ...
                    confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            game5DbRef.child("resetBy").setValue(myPhoneNumber);
                            game5DbRef.child("scoreStatus").setValue("2");
                ...
                public void onClick(View v) {
                    ...
                    confirmDialog.confirmAccept.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            game5DbRef.child("scoreStatus").setValue("0");
